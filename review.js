...
var userTitleInput = document.getElementById("userTitleInput");
var userNameInput = document.getElementById("userNameInput");
var userReviewInput = document.getElementById("userReviewInput");
var reviewSendBtn = document.getElementById("reviewSend");
...
reviewSendBtn.addEventListener("click", () => {
  ...
  userTitleInput = userTitleInput.value;
  userNameInput = userNameInput.value;
  userReviewInput = userReviewInput.value;

  console.log(userTitleInput, userNameInput, userReviewInput);

  // createReviewRow(userTitleInput, userNameInput, userReviewInput);
  ...
  var reviewElements = `
          ...
          <div class="review">
            <h4 class="title">${userTitleInput}</h4>
            <p class="user-name">${userNameInput}</p>
            <p class="review">${userReviewInput}</p>
          </div>
  
  `;

  showRow.innerHTML = reviewElements;
  document.getElementById("review-show-wrapper").appendChild(showRow);
...
// function createReviewRow(userTitleInput, userNameInput, userReviewInput) {
//   var showRow = document.createElement("div");
//   showRow.classList.add("show-row");
...
//   showRow.innerHTML = reviewElements;
//   var reviewShowWrapper = document.getElementsById("review-show-wrapper");
//   reviewShowWrapper.append(showRow);
// }

// ----
// showRow.appendChild(reviewRowElements);
